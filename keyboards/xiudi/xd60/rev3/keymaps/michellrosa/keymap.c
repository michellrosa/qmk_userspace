...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BRL] = LAYOUT_60_ansi_split_bs_rshift_space(
        _______, _______, _______, _______, _______, _______, FKBR_6, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_BRQL] = LAYOUT_60_ansi_split_bs_rshift_space(
        FKBR_QUOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, _BRL, _FL, _BRQL); // Override KC_GRV with FKBR_QUOT.
}
